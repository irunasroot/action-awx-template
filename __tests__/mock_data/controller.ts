const CONTROLLER_INSTANCE = {
  ...
  controller_username: 'irunasroot',
  controller_password: 'irunasroot',
  controller_token: 'a20b9b78-8420-4af7-858d-7e6d5b4dd31c',
  controller_timeout: 1000,
  controller_verify_certificate: true
}

export { CONTROLLER_INSTANCE }
